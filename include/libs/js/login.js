$('.account_info').on("click",function(){
  ...
  function check_username(){
    ...
    if(username == "" || username.length <= 0){
      ...
      $('#error-username').text('กรุณากรอก Username ในการเข้าสู่ระบบ');
    }else{
  ...
  function check_password(){
    ...
    if(password == "" || password.length <= 0){
      ...
      $('#error-password').text('กรุณากรอก Password ในการเข้าสู่ระบบ');
          ...
          beforeSend: function() {
            ...
            $('.btn-loading').removeClass("d-none");
              ...
              if(result == "success"){
                  ...
                  $('.alert-incorrect').removeClass('d-none').text('ชื่อผู้ใช้ หรือ รหัสผ่านไม่ถูกต้อง');
                  $('#username').addClass('is-invalid');
                  $('#password').addClass('is-invalid');
                  $("form")[0].reset();
