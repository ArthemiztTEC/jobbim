...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2020 at 10:47 AM
...
CREATE TABLE `employee` (
  ...
  `districts_id` int(6) NOT NULL COMMENT 'ตำบล',
  `amphures_id` int(5) NOT NULL COMMENT 'อำเภอ',
  `provinces_id` int(5) NOT NULL COMMENT 'จังหวัด',
  `employee_phone` varchar(15) NOT NULL COMMENT 'เบอร์นายจ้าง',
  `employee_email` varchar(50) NOT NULL COMMENT 'อีเมลนายจ้าง',
  `employee_image` varchar(100) NOT NULL COMMENT 'รูปนายจ้าง',
...
CREATE TABLE `freelance` (
  ...
  `fl_image` varchar(100) NOT NULL COMMENT 'รูปฟรีแลนซ์',
...
INSERT INTO `freelance` (`fl_id`, `fl_username`, `fl_password`, `fl_prefix`, `fl_fname`, `fl_lname`, `fl_birthday`, `fl_idcard`, `fl_address`, `districts_id`, `amphures_id`, `provinces_id`, `fl_phone`, `fl_email`, `fl_job`, `fl_image`, `fl_license`, `LoginStatus`, `LastUpdate`) VALUES
(1, 'trident', 'trident123456', 'นาย', 'fTrident', 'lTrident', '1998-05-16', '1509970156753', '2 หมู่ 2 บ้านวัง ', 100106, 1, 1, '0620563254', 'email@gmail.com', ' งานไฟฟ้า, งานโยธา', 'user.jpg', 'license.jpg', 0, '2020-12-17 14:45:46');
...
--
ALTER TABLE `freelance`
  MODIFY `fl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีฟรีแลนซ์', AUTO_INCREMENT=2;
