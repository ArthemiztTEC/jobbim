...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2020 at 07:00 AM
...
CREATE TABLE `check_login` (
  `check_id` int(11) NOT NULL COMMENT 'pkเช็คloginตรวยเข้าระบบ',
  `username` varchar(100) NOT NULL COMMENT 'ชื่อผู้ใช้เอาไว้ตรวจสอบ',
  `password` varchar(100) NOT NULL COMMENT 'พาสเอาไว้ตรวจสอบ',
  `status` varchar(1) NOT NULL COMMENT 'สถานะเอาไว้ตรวจสอบ'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `check_login` (`check_id`, `username`, `password`, `status`) VALUES
(1, 'trident', 'trident123456', '0'),
(2, 'trident1', 'trident123456', '0'),
(3, 'trident2', 'trident123456', '0'),
(4, 'trident3', 'trident123456', '0'),
(5, 'trident4', 'trident123456', '0'),
(6, 'trident5', 'trident123456', '0'),
(7, 'employee', 'employee123456', '1');
...
CREATE TABLE `employee` (
  `employee_id` int(11) NOT NULL COMMENT 'ไอดีนายจ้าง',
  `employee_username` varchar(100) NOT NULL COMMENT 'ชื่อนายจ้าง',
  `employee_password` varchar(100) NOT NULL COMMENT 'พาสนายจ้าง',
  `employee_prefix` varchar(20) NOT NULL COMMENT 'คำนำหน้านายจ้าง',
  `employee_fname` varchar(100) NOT NULL COMMENT 'ชื่อต้นนายจ้าง',
  `employee_lname` varchar(100) NOT NULL COMMENT 'นามสกุลนายจ้าง',
  `sex_id` int(11) NOT NULL COMMENT 'fkของtableSex',
  `employee_birthday` date NOT NULL COMMENT 'วันเกิดนายจ้าง',
  `employee_idcard` varchar(20) NOT NULL COMMENT 'เลขบัตรนายจ้าง',
  `employee_address` varchar(200) NOT NULL COMMENT 'ที่อยู่นายจ้าง',
  `districts_id` int(6) NOT NULL COMMENT 'fkของtableตำบล',
  `amphures_id` int(5) NOT NULL COMMENT 'fkของtableอำเภอ',
  `provinces_id` int(5) NOT NULL COMMENT 'fkของtableจังหวัด',
  `employee_phone` varchar(15) NOT NULL COMMENT 'เบอร์นายจ้าง',
  `employee_email` varchar(50) NOT NULL COMMENT 'อีเมลนายจ้าง',
  `employee_image` varchar(100) DEFAULT NULL COMMENT 'รูปนายจ้าง',
  `employee_status` varchar(1) NOT NULL COMMENT 'สถานะการใช้งานนายจ้าง',
  `LoginStatus` int(1) DEFAULT NULL COMMENT 'สถานะออนนายจ้าง',
  `LastUpdate` datetime DEFAULT NULL COMMENT 'เวลาล่าสุดนายจ้าง'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `employee` (`employee_id`, `employee_username`, `employee_password`, `employee_prefix`, `employee_fname`, `employee_lname`, `sex_id`, `employee_birthday`, `employee_idcard`, `employee_address`, `districts_id`, `amphures_id`, `provinces_id`, `employee_phone`, `employee_email`, `employee_image`, `employee_status`, `LoginStatus`, `LastUpdate`) VALUES
(1, 'employee', 'employee123456', 'นาย', 'femployee', 'lemployee', 1, '1995-12-20', '1509941202111', '65 หมู่ 1 บ้านสวน', 100106, 1, 1, '0623254589', 'employee@gmail.com', NULL, '0', NULL, NULL);
...
CREATE TABLE `freelance` (
  `fl_id` int(11) NOT NULL COMMENT 'ไอดีฟรีแลนซ์',
  `fl_username` varchar(100) NOT NULL COMMENT 'ชื่อฟรีแลนซ์',
  `fl_password` varchar(100) NOT NULL COMMENT 'พาสฟรีแลนซ์',
  `fl_prefix` varchar(20) NOT NULL COMMENT 'คำนำหน้าฟรีแลนซ์',
  `fl_fname` varchar(100) NOT NULL COMMENT 'ชื่อต้นฟรีแลนซ์',
  `fl_lname` varchar(100) NOT NULL COMMENT 'นามสกุลฟรีแลนซ์',
  `sex_id` int(11) NOT NULL COMMENT 'fkของtableSex',
  `fl_birthday` date NOT NULL COMMENT 'วันเกิดฟรีแลนซ์',
  `fl_idcard` varchar(20) NOT NULL COMMENT 'เลขบัตรฟรีแลนซ์',
  `fl_address` varchar(200) NOT NULL COMMENT 'ที่อยู่ฟรีแลนซ์',
  `districts_id` int(6) NOT NULL COMMENT 'fkของtableตำบล',
  `amphures_id` int(5) NOT NULL COMMENT 'fkของtableอำเภอ',
  `provinces_id` int(5) NOT NULL COMMENT 'fkของtableจังหวัด',
  `fl_phone` varchar(15) NOT NULL COMMENT 'เบอร์ฟรีแลนซ์',
  `fl_email` varchar(50) NOT NULL COMMENT 'อัเมลฟรีแลนซ์',
  `fl_job` varchar(100) NOT NULL COMMENT 'งานฟรีแลนซ์',
  `fl_image` varchar(100) DEFAULT NULL COMMENT 'รูปฟรีแลนซ์',
  `fl_license` varchar(100) DEFAULT NULL COMMENT 'ใบกวฟรีแลนซ์',
  `fl_status` varchar(1) NOT NULL COMMENT 'สถานะการใช้งานฟรีแลนซ์',
  `LoginStatus` int(1) DEFAULT NULL COMMENT 'สถานะออนฟรีแลนซ์',
  `LastUpdate` datetime DEFAULT NULL COMMENT 'เวลาล่าสุดฟรีแลนซ์'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `freelance` (`fl_id`, `fl_username`, `fl_password`, `fl_prefix`, `fl_fname`, `fl_lname`, `sex_id`, `fl_birthday`, `fl_idcard`, `fl_address`, `districts_id`, `amphures_id`, `provinces_id`, `fl_phone`, `fl_email`, `fl_job`, `fl_image`, `fl_license`, `fl_status`, `LoginStatus`, `LastUpdate`) VALUES
(1, 'trident', 'trident123456', 'นาย', 'fTrident', 'lTrident', 1, '1998-05-16', '1509970156753', '2 หมู่ 2 บ้านวัง ', 100106, 1, 1, '0620563254', 'email@gmail.com', '1,2', 'construction3.jpg', 'license.jpg', '0', 0, '2020-12-17 14:45:46'),
(2, 'trident1', 'trident123456', 'นาย', 'fTrident1', 'lTrident1', 1, '1998-05-16', '1509970156754', '2 หมู่ 2 บ้านวัง 1', 100106, 1, 1, '0620563255', 'email1@gmail.com', '2,3', '', 'license.jpg', '0', 0, '2020-12-17 14:45:46'),
(3, 'trident2', 'trident123456', 'นาย', 'fTrident2', 'lTrident2', 2, '1998-05-16', '1509970156755', '2 หมู่ 2 บ้านวัง 1', 100106, 1, 1, '0620563256', 'email1@gmail.com', '4', '', 'license.jpg', '0', 0, '2020-12-17 14:45:46'),
(4, 'trident3', 'trident123456', 'นาย', 'fTrident3', 'lTrident3', 1, '1998-05-16', '1509970156756', '2 หมู่ 2 บ้านวัง 1', 100106, 1, 1, '0620563256', 'email1@gmail.com', '5', '', 'license.jpg', '0', 0, '2020-12-17 14:45:46'),
(5, 'trident4', 'trident123456', 'นาย', 'fTrident4', 'lTrident4', 1, '1998-05-16', '1509970156756', '2 หมู่ 2 บ้านวัง 1', 100106, 1, 1, '0620563256', 'email1@gmail.com', '6', '', 'license.jpg', '0', 0, '2020-12-17 14:45:46'),
(6, 'trident5', 'trident123456', 'นาย', 'fTrident5', 'lTrident5', 1, '1998-05-16', '1509970156758', '2 หมู่ 2 บ้านวัง 1', 100106, 1, 1, '0620563256', 'email1@gmail.com', '2', '', 'license.jpg', '0', 0, '2020-12-17 14:45:46');
...
--
-- Table structure for table `tb_freelance_direct`
--

CREATE TABLE `tb_freelance_direct` (
  `fl_direct_id` int(11) NOT NULL COMMENT 'ไอดีฟรีแลนซ์แนะนำ',
  `fl_id` int(11) NOT NULL COMMENT 'ไอดีฟรีแลนซ์',
  `fl_direct_detail` int(11) NOT NULL COMMENT 'รายละเอียดงานฟรีแลนซ์',
  `fl_direct_date` int(11) NOT NULL COMMENT 'วันที่ลงแนะนำฟรีแลนซ์',
  `fl_direct_status` int(11) NOT NULL COMMENT 'สถานะฟรีแลนซ์'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `tb_freelance_rating`
--

CREATE TABLE `tb_freelance_rating` (
  `fl_rating_id` int(11) NOT NULL,
  `fl_id` int(11) NOT NULL,
  `employee_id` int(11) NOT NULL,
  `fl_rating_comment` varchar(200) NOT NULL,
  `fl_rating` int(11) NOT NULL,
  `fl_rating_date` date NOT NULL DEFAULT current_timestamp()
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_job` (
  ...
  `job_detail` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_job` (`job_id`, `job_detail`) VALUES
(1, 'เขียนแบบ BIM'),
(2, 'งานสถาปัตยกรรม'),
(3, 'งานไฟฟ้า'),
(4, 'งานโยธา'),
...
CREATE TABLE `tb_messages` (
  `messages_id` int(11) NOT NULL COMMENT 'ไอดีข้อความ',
  `fl_id` int(11) NOT NULL COMMENT 'ไอดีฟรีแลนซ์',
  `employee_id` int(11) NOT NULL COMMENT 'ไอดีนายจ้าง',
  `message` varchar(255) NOT NULL COMMENT 'ข้อความ',
  `createdAt` varchar(255) NOT NULL COMMENT 'เวลาพิมพ์ข้อความ'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_sex` (
  `sex_id` int(11) NOT NULL COMMENT 'ไอดีเพศ',
  `sex_detail` varchar(50) NOT NULL COMMENT 'รายละเอียดเพศ',
  `sex_image` varchar(200) NOT NULL COMMENT 'รูปเพศ'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_sex` (`sex_id`, `sex_detail`, `sex_image`) VALUES
(1, 'ชาย', 'profile_male.png'),
(2, 'หญิง', 'profile_female.png');
...
--
-- Indexes for table `tb_freelance_direct`
--
ALTER TABLE `tb_freelance_direct`
  ADD PRIMARY KEY (`fl_direct_id`);

--
-- Indexes for table `tb_freelance_rating`
--
ALTER TABLE `tb_freelance_rating`
  ADD PRIMARY KEY (`fl_rating_id`);
...
--
ALTER TABLE `check_login`
  MODIFY `check_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'pkเช็คloginตรวยเข้าระบบ', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีนายจ้าง', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `freelance`
--
ALTER TABLE `freelance`
  MODIFY `fl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีฟรีแลนซ์', AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `tb_freelance_direct`
--
ALTER TABLE `tb_freelance_direct`
  MODIFY `fl_direct_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีฟรีแลนซ์แนะนำ';

--
-- AUTO_INCREMENT for table `tb_freelance_rating`
--
ALTER TABLE `tb_freelance_rating`
  MODIFY `fl_rating_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_messages`
  MODIFY `messages_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีข้อความ';

--
-- AUTO_INCREMENT for table `tb_sex`
--
ALTER TABLE `tb_sex`
  MODIFY `sex_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีเพศ', AUTO_INCREMENT=3;
COMMIT;
